...
import { UrbanTransportationLanguageMetaData } from '../language/generated/module.js';
...
export default function(): void {
    ...
    const fileExtensions = UrbanTransportationLanguageMetaData.fileExtensions.join(', ');
    program
        .command('generate')
